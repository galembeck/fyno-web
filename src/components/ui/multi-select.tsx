/** biome-ignore-all lint/complexity/noExcessiveCognitiveComplexity: required by multi-select component */
/** biome-ignore-all lint/a11y/useSemanticElements: required by multi-select component */
/** biome-ignore-all lint/style/useBlockStatements: required by multi-select component */
/** biome-ignore-all lint/nursery/noShadow: required by multi-select component */
/** biome-ignore-all lint/complexity/noForEach: required by multi-select component */
  ...
  (
    ...
    const handleInputKeyDown = (
      ...
      if (event.key === "Enter") {
        ...
        event.key === "Backspace" &&
        !(
          event.currentTarget && (event.currentTarget as HTMLInputElement).value
        )
      ) {
