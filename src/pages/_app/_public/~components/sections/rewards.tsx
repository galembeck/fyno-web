      ...
      <div className="mx-auto max-w-7xl space-y-4 md:grid md:grid-cols-3 md:gap-4 md:space-y-0 lg:gap-6">
        ...
        <div className="relative flex min-h-[200px]">
          <img
            ...
            src="https://framerusercontent.com/images/5JE1AqN7Min4cFdyj1rr8zKrK8.jpg?scale-down-to=1024&width=3294&height=2396"
          />
        </div>
        ...
        <div className="relative h-64">
          <img
            ...
            src="https://framerusercontent.com/images/junTJQ8fbUFNiQVvbD7nuloGrs.jpg?scale-down-to=1024&width=2018&height=2083"
          />
        </div>
        ...
        <div className="relative h-64">
          <img
            alt="Person"
            className="absolute inset-0 h-full w-full rounded-2xl object-cover"
            src="https://framerusercontent.com/images/aknhz2l3hMaMkRxsLjyc1KlxKaI.jpg?scale-down-to=1024&width=2667&height=3697"
          />
        </div>
        ...
        <div className="relative h-52 overflow-hidden rounded-2xl md:col-span-1">
          <img
            ...
            src="https://framerusercontent.com/images/ESrKE7Ybglu2MIi5mPPDlV0uNt8.png?width=1080&height=1920"
          />
        </div>
