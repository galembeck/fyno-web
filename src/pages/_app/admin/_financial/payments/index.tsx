...
export const Route = createFileRoute("/_app/admin/_financial/payments/")({
			...
			<Card>
				<CardHeader>
					...
					<CardDescription className="text-base">
						Visualize e gerencie todos os pagamentos realizados em sua plataforma através da tabela de pagamentos
					</CardDescription>
