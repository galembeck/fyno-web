...
import complaints from "./~content/complaints.md?raw";

export const Route = createFileRoute("/_app/_related/_compliance/complaints")({
		...
		<main className="flex flex-col">
			<div className="bg-gradient-to-b from-white to-third-green-light py-10 lg:py-20 dark:from-primary-dark dark:to-secondary-dark">
				<div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
					<h1 className="text-center font-bold text-5xl">Denúncias</h1>
				</div>
			</div>
