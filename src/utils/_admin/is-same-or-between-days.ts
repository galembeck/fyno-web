/** biome-ignore-all lint/nursery/useNumericSeparators: required by calendar */
...
export function isSameOrBetweenDays(date: Date, from: Date, to: Date) {
	...
	const dNum = d[0] * 10000 + d[1] * 100 + d[2];
	const fNum = f[0] * 10000 + f[1] * 100 + f[2];
	const tNum = t[0] * 10000 + t[1] * 100 + t[2];
